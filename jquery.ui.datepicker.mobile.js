...
(function($, undefined) {
	...
	$(".ui-page").live("pagecreate", function() {
		$("input[type='date'], input:jqmData(type='date')", this).each(function() {
			...
			var popupId = fieldId + "Popup";
			$("#" + popupId).datepicker({
				dateFormat : "yy-mm-dd",
				altField : "#" + $(this).attr("id"),
				showOtherMonths : true,
				onSelect: function(dateText, inst) {
					console.log("date change, close the popup");
					$("#" + popupId).popup("close");
				}
			});
		})
		
		$("input[type='date'], input:jqmData(type='date')", this).click(function() {
			var fieldId = $(this).attr("id");
			var popupId = fieldId + "Popup";
			var selector = "a[href=#" + popupId + "]";
			console.log("going to click: " + selector);
			$(selector).click();
		})
	});
})(jQuery); 